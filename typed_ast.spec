...
%prep
%setup -q -n typed_ast-1.4.2
cd %{_builddir}/typed_ast-1.4.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609790400
...
cp %{_builddir}/typed_ast-1.4.2/LICENSE %{buildroot}/usr/share/package-licenses/typed_ast/5cba2695438a74e1f7a057b4fe6ec39bc444a0fc
