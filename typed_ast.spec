...
Source0  : https://files.pythonhosted.org/packages/6e/08/c04a49ee26a94c1ec211e7b1e5f2971d692e04818ea67ef70f1e879cf525/typed_ast-1.4.3.tar.gz
...
%prep
%setup -q -n typed_ast-1.4.3
cd %{_builddir}/typed_ast-1.4.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618250129
...
cp %{_builddir}/typed_ast-1.4.3/LICENSE %{buildroot}/usr/share/package-licenses/typed_ast/5cba2695438a74e1f7a057b4fe6ec39bc444a0fc
