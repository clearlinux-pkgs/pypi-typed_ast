...
Version  : 1.5.2
Release  : 52
URL      : https://files.pythonhosted.org/packages/4a/9c/f35b20518e633f4df40e9e47eb17b92ec122be52153ac0d6f28419489cf1/typed_ast-1.5.2.tar.gz
...
%prep
%setup -q -n typed_ast-1.5.2
cd %{_builddir}/typed_ast-1.5.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643043289
...
cp %{_builddir}/typed_ast-1.5.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-typed_ast/5cba2695438a74e1f7a057b4fe6ec39bc444a0fc
